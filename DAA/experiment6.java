// To implement Buffman Ford algorithm and analyse its time complexity.
...
class experiment6 {
  ...
  void BellmanFordAlgorithm(experiment6 graph, int source) {
  ...
  public static void main(String[] args) {
    ...
    experiment6 graph = new experiment6(V, E);
